...
@IBDesignable
open class IndicatorBar: UIView {
    ...
    open var items = [HorizontalCategoryBarCellItem]()
    ...
    private func setUp() {
        ...
        collectionView.register(HorizontalCategoryBarCell.self, forCellWithReuseIdentifier: "cell")
...
public struct HorizontalCategoryBarCellItem {
    public var action: ((_ item: HorizontalCategoryBarCellItem) -> Void)? = nil
    public var width: CGFloat = 80.0
}

open class HorizontalCategoryBarCell: UICollectionViewCell {
    ...
    open var item: HorizontalCategoryBarCellItem? {
        didSet {
...
extension IndicatorBar: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! HorizontalCategoryBarCell
